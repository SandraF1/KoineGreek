// src/components/GreekPronounsIntro.jsx
import React from "react";

export default function GreekPronounsIntro() {
  return (
    <div className="unit-section">
      <h2>Introduction to Personal Pronouns in Koine Greek</h2>
      <p>
        In English, we have short words that replace nouns or proper nouns. For
